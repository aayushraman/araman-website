...
I am a Postdoc Associate at [Broad Institute of MIT and Harvard](https://broadinstitute.org/) with secondary appointmenets at [Dana Farber Cancer Institute](https://ds.dfci.harvard.edu/) and [MGH, Harvard Medical School](https://www.massgeneral.org/pathology/research). I am working with the labs of [Martin Aryee](https://aryee.mgh.harvard.edu/), [Alex Meissner](https://hscrb.harvard.edu/people/alexander-meissner/), and [Andi Gnirke](https://www.broadinstitute.org/epigenomics/team) to understand the dynamics of gene regulation using single-cell genomics.  
...
{{< icon name="download" pack="fas" >}}{{< staticref "media/CV_website.pdf" "newtab" >}}CV{{< /staticref >}}.
